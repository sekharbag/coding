...
class C:public A{ //c_ka_public as pu// a_ka_public ,a_ka_proacted  as protacted ,b_ka_public  as public 
    public:
    int c_ka_public;
     C(){
...
class D:public B,public C{ //c_ka_public as pu// a_ka_public ,a_ka_proacted  as protacted ,b_ka_public  as public 
    public:
    int d_ka_public;
    void show()
    {
